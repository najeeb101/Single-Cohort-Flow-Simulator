...
export default function ConfigStep({
  ...
  setRecordField: (key: "passRates" | "initialOccupancy", code: string, value: number) => void;
}) {
  return (
    <div className="flex flex-col gap-4">
      <AdmissionsTab mode="advanced" state={state} baseline={baseline} courses={courses} setField={setField} setRecordField={setRecordField} mandatoryTerms={meta.mandatory_terms} />
      <PassRatesDropoutTab
        mode="advanced"
        meta={meta}
        state={state}
