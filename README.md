...
curriculum/config/plans/live-simulation endpoints backed by a SQLite database).
...
docs/        project_overview.md, technical_design.md, assumptions.md, deployment.md
run.py       entry point
```
...
- **[docs/deployment.md](docs/deployment.md)** — deploying a live instance (Render blueprint: backend + frontend + Postgres).
